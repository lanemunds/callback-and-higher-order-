...
const newMixedNumber = mixedNumbers.filter(function(num){
 return num % 2 === 0})
// console.log(newMixedNumber)
...
// CODE HERE
const myStrongest = monstersInYourPocket.filter((el) => el.CP > 20)
...
const withTax = orders.map((taxes)=>taxes.price + (taxes.price*taxes.tax))
// console.log(withTax)
...
const bobsTotal = purchases.reduce((acc, current) => {
